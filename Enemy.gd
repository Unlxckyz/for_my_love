...
var health: int = 50
var hurt: bool = false
var detection_radius: float = 200.0  # Raio de detecção do jogador
var patrol_radius: float = 150.0  # Raio limite para patrulha
...
@onready var patrol_timer = $PatrolTimer # Adiciona um timer para patrulha
...
func patrol() -> void:
	# Se o inimigo está longe demais da posição original, mova-o de volta
